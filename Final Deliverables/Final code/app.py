...
app.config['hostname'] = "824dfd4d-99de-440d-9991-629c01b3832d.bs2io90l08kqb1od8lcg.databases.appdomain.cloud"
app.config['port'] = '30119'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'jkq97323'
app.config['pwd'] = 'W5o6cpE8SBYpTFZf'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=824dfd4d-99de-440d-9991-629c01b3832d.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;port=30119;protocol=tcpip;\
            uid=jkq97323;pwd=W5o6cpE8SBYpTFZf;security=SSL'
...
def display():
    ...
    for x in expense:
          ...
          if (x[6] == ("food")):
              ...
              t_other  += x[4]
    print(t_food, t_entertainment,t_business  ,t_rent, t_EMI,t_other )
    return render_template('display.html' , expense = expense,  total = total ,t_food = t_food,t_entertainment =  t_entertainment,t_business = t_business,  t_rent =  t_rent, t_EMI =  t_EMI,  t_other =  t_other)
